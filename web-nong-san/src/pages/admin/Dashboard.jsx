...
const chartHeights = ["h-[40%]", "h-[55%]", "h-[45%]", "h-[70%]", "h-[60%]", "h-[85%]", "h-[75%]", "h-[95%]", "h-[80%]", "h-[65%]", "h-[50%]", "h-[70%]"];
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-4 h-1 w-full overflow-hidden rounded-full bg-slate-100">
                      <div className={`h-full rounded-full ${barClass} ${item.width}`} />
                    </div>
                  </article>
                );
              })}
                    ...
                    {orders.map((order) => (
                      <tr key={order.id} className="transition hover:bg-slate-50/50">
                        ...
                        <td className="px-8 py-5">
                          <span className={`rounded-full px-3 py-1 text-[10px] font-bold ${order.badge}`}>
                            {order.status}
                          </span>
                        </td>
                        <td className="px-8 py-5 text-sm font-bold text-slate-900">
